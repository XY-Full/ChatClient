...
PROTOBUF_CONSTEXPR test::test(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::internal::ZeroFieldsBase(test_class_data_.base()){}
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::internal::ZeroFieldsBase(arena, test_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
constexpr auto test::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(test),
                                            alignof(test));
}
constexpr auto test::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          &test::MergeImpl,
          ::google::protobuf::internal::ZeroFieldsBase::GetNewImpl<test>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &test::SharedDtor,
          ::google::protobuf::internal::ZeroFieldsBase::GetClearImpl<test>(), &test::ByteSizeLong,
...
test::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::cs::test>(),  // to_prefetch
